...
export default function EditRecipe() {
    ...
    useEffect(()=>{
        const getData=async()=>{
            await axios.get(`https://apnirasoi-add-food-recipe.onrender.com/recipe/${id}`)
            .then(response=>{
    ...
    const onHandleSubmit = async (e) => {
        ...
        await axios.put(`https://apnirasoi-add-food-recipe.onrender.com/recipe/${id}`, recipeData,{
            headers:{
